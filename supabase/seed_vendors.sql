...
INSERT INTO public.vendors (user_id, name, location_name, city, latitude, longitude, capacity_total, hours, tags)
SELECT u.id, v.name, v.location_name, v.city, v.lat, v.lng, v.cap, v.hours::jsonb, v.tags
FROM (VALUES
  ('seed-vendor-01@carrera-gourmet.demo', 'Tacos El Portales', 'Portales Sur', 'CDMX', 19.3712, -99.1405, 18, '{"mon":"10-22","tue":"10-22","wed":"10-22","thu":"10-22","fri":"10-23","sat":"10-23","sun":"11-21"}', ARRAY['Traditional','Beef','Spicy']),
  ('seed-vendor-02@carrera-gourmet.demo', 'Antojitos La Güela', 'Portales Sur', 'CDMX', 19.3688, -99.1420, 15, '{"mon":"10-22","tue":"10-22","wed":"10-22","thu":"10-22","fri":"10-23","sat":"10-23","sun":"11-21"}', ARRAY['Traditional','Vegetarian']),
  ('seed-vendor-03@carrera-gourmet.demo', 'Tacos CU — ESCOM', 'Ciudad Universitaria, ESCOM', 'CDMX', 19.3244, -99.1778, 22, '{"mon":"9-21","tue":"9-21","wed":"9-21","thu":"9-21","fri":"9-22","sat":"10-20","sun":"10-19"}', ARRAY['Traditional','Budget','Spicy']),
  ('seed-vendor-04@carrera-gourmet.demo', 'Elotes del Pedregal', 'ESCOM, Ciudad Universitaria', 'CDMX', 19.3255, -99.1795, 12, '{"mon":"16-23","tue":"16-23","wed":"16-23","thu":"16-23","fri":"16-24","sat":"14-24","sun":"14-22"}', ARRAY['Vegetarian','Vegan']),
  ('seed-vendor-05@carrera-gourmet.demo', 'Tacos del Zócalo', 'Centro Histórico, Zócalo', 'CDMX', 19.4328, -99.1332, 30, '{"mon":"8-22","tue":"8-22","wed":"8-22","thu":"8-22","fri":"8-23","sat":"8-23","sun":"9-21"}', ARRAY['Traditional','Beef']),
  ('seed-vendor-06@carrera-gourmet.demo', 'Barbacoa Don Pepe', 'Zócalo', 'CDMX', 19.4340, -99.1345, 20, '{"mon":"7-15","tue":"7-15","wed":"7-15","thu":"7-15","fri":"7-15","sat":"7-16","sun":"7-16"}', ARRAY['Traditional','Beef']),
  ('seed-vendor-07@carrera-gourmet.demo', 'Tortas Azteca', 'Estadio Azteca', 'CDMX', 19.3030, -99.1510, 25, '{"mon":"10-22","tue":"10-22","wed":"10-22","thu":"10-22","fri":"10-23","sat":"10-23","sun":"11-21"}', ARRAY['Traditional','Pork']),
  ('seed-vendor-08@carrera-gourmet.demo', 'Carnitas Calzada', 'Calzada de Tlalpan, Estadio Azteca', 'CDMX', 19.3015, -99.1495, 18, '{"mon":"9-20","tue":"9-20","wed":"9-20","thu":"9-20","fri":"9-21","sat":"9-21","sun":"10-18"}', ARRAY['Pork','Traditional']),
  ('seed-vendor-09@carrera-gourmet.demo', 'Birrieria El Compadre', 'Centro Histórico', 'Guadalajara', 20.6597, -103.3496, 24, '{"mon":"8-20","tue":"8-20","wed":"8-20","thu":"8-20","fri":"8-21","sat":"8-21","sun":"9-19"}', ARRAY['Traditional','Beef']),
  ('seed-vendor-10@carrera-gourmet.demo', 'Elotes y Esquites La Güera', 'Parque Fundidora', 'Monterrey', 25.6866, -100.3161, 14, '{"mon":"16-23","tue":"16-23","wed":"16-23","thu":"16-23","fri":"16-24","sat":"14-24","sun":"14-22"}', ARRAY['Vegetarian','Vegan'])
) AS v(email, name, location_name, city, lat, lng, cap, hours, tags)
